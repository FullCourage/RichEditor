...
RE.insertHandHtml = function(contents) {
    RE.insertHTML('<div class=file_text></div>');
    var elements = document.getElementsByClassName("file_text");
    elements[elements.length-1].innerHTML =decodeURIComponent(contents.replace(/\+/g, '%20'));
    //document.getElementById('file_text').innerHTML =decodeURIComponent(contents.replace(/\+/g, '%20'));
    RE.callback();
}
